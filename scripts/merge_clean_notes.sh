...
pySLURMargs.py $userName $memory $condaEnv $nGPU "../src/merge_clean_notes.py $data_dir_obs $data_dir_clin $json_dir_obs $json_dir_clin $mrn_file $save_dir $file_part_max_obs $file_part_max_clin"