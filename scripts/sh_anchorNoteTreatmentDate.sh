...
pySLURMargs.py $userName $memory $condaEnv $nGPU "../src/make_notes_dataset/anchorNoteTreatmentDate.py $dataPath $treatmentDataPath $targetDataPath $saveDir $configName $testEndDate $eventName $lookbackWindow" 