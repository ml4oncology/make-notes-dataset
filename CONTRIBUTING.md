...
Welcome to `make_notes_dataset` contributor's guide.
...
If you experience bugs or general issues with `make_notes_dataset`, please have a look
...
You can help improve `make_notes_dataset` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`make_notes_dataset` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `make_notes_dataset`'s files. While this mechanism can
...
```
conda create -n make_notes_dataset python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/make_notes_dataset.git
   cd make_notes_dataset
   ```
...
5. Install [pre-commit]:
   ...
   `make_notes_dataset` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/make_notes_dataset
[issue tracker]: https://github.com/<USERNAME>/make_notes_dataset/issues
